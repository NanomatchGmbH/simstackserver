...
class ClusterManager:
    ...
    def get_directory(
        ...
        self._get_directory_recurse_helper(
            from_directory_on_server, to_directory, optional_callback, basepath_override
        )

    def _get_directory_recurse_helper(
        self,
        from_directory_on_server_resolved: str,
        to_directory: str,
        optional_callback=None,
        basepath_override=None,
    ):
        if not self.exists_remote(from_directory_on_server_resolved):
            raise FileNotFoundError(
                f"Directory {from_directory_on_server_resolved} not found on server."
            )
