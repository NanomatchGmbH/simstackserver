...
from wano_calcjob.calculations import Deposit3CalcJob, Deposit3Parser, EmissionCalcJob, EmissionParser
...
def get_parsed_em_xml():
    ...
    rendered_wano = wmr.get_valuedict_with_aiida_types(aiida_files_by_relpath=aiida_files_by_relpath)
    import aiida
    aiida.load_profile()
    ...
    rendered_wano["static_extra_files"]["rendered_wanoyml"] = orm.SinglefileData(join(depdir(), "rendered_wano.yml"))
