...
###########################################################
    ...
    cd /home/username/nanoscope/calculations/2025-03-13-15h27m49s-RandomFlow/exec_directories/2025-03-13-15h27m54s-TestNMSetup
    export HOSTFILE=/home/username/nanoscope/calculations/2025-03-13-15h27m49s-RandomFlow/exec_directories/2025-03-13-15h27m54s-TestNMSetup/HOSTFILE
    #!/bin/bash
